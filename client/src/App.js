...
const socket= io('https://servidor-aplicacion-chat-bl0b7a1zy-jfelipemendez21.vercel.app/:'+port);
...
function App() {  
  ...
  const url="https://servidor-aplicacion-chat-bl0b7a1zy-jfelipemendez21.vercel.app/:"+port+"/api/";
